  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
	<div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4><?php if(isset($this->params['pass'][1]) && !empty($this->params['pass'][1])){echo "View Organiser";}else{echo "Edit Organiser";}?></h4>
          </div>
          <div class="col-sm-6">
            <button class="btn btn-primary" onclick="window.location.href='<?php echo SITE_PATH."admin/Organisers/manage_organisers"?>'" style="float:right">Manage Player</button>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form role="form" id="addUser" method="post" action ="<?php echo SITE_PATH.'admin/Organisers/view_organiser/'.$this->params['pass'][0];?>" >
							<div class="card-body">
								...
								<div class="form-group">
									<label>Game</label>
									<input type="text" class="form-control required" readonly  value="<?php echo $totalGame;?>">
								</div>
								<div class="form-group">
									<label>Venue</label>
									<input type="text" class="form-control required" readonly value="<?php echo $totalVenue;?>">
								</div>
								<div class="form-group">
									<label>Tournament</label>
									<input type="text" class="form-control required" readonly value="<?php echo $totalTournament;?>">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<?php if(isset($view)&& !empty($view)){?>
									<input type="text" class="form-control required" name="admin_status" readonly  value="<?php echo ($result['User']['admin_status']==1?'Active':'Inactive');?>">
									<?php }else{?>
									<select class="form-control required" name="admin_status">
										<option value="1"<?php echo (!empty($result)?($result['User']['admin_status']==1 ? 'selected':''):'');?>>Active</option>
										<option value="0"<?php echo (!empty($result)?($result['User']['admin_status']==0 ? 'selected':''):'');?>>Inactive</option>
									</select>
									<?php }?>
								</div>
