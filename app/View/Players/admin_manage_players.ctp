				...
				if($result){
					...
					?>
						<tr>
							...
							<td>
								<a href="<?php echo SITE_PATH.'admin/Players/view_player/'.$res['User']['id'].'/1';?>" title = "View"><i class="fa fa-eye"></i></a>
								<a href="<?php echo SITE_PATH.'admin/Players/view_ratings/'.$res['User']['id'];?>" title = "Rating"><img src="<?php echo SITE_PATH."img/view.png"?>" width="20px" height ="20px"></a>
								<a href="<?php echo SITE_PATH.'admin/Players/view_player/'.$res['User']['id'];?>" title = "Edit"><i class="fa fa-edit"></i></a>
								<a href="#" onclick="del_confirm('Are you Sure want to delete this record?','<?php echo SITE_PATH.'admin/Players/delete/'.$res['User']['id'];?>')" title = "Delete"><i class="fa fa-trash"></i></a>
							</td>
  ...
  <!-- /.content-wrapper -->
	<script>
		...
		function changeAdminStatus(user_id,status){
			url="<?php echo SITE_PATH ?>admin/Players/verifyStatus",
			$.ajax({
				url : url,
				type:'GET',
				async:false,
