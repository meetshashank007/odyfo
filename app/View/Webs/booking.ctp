...
<div id="wrapper"> 
  ...
  <div class="contact-section clearfix booking-section">
    <div class="contact-form">
      <div class="col-md-12">
        <div class="contact-text">
          <h4>We would love to hear from you. </h4>
          <h5>Please provide your details and we will be in touch.</h5>
		  <div class="message" style="color:green"><?php echo $this->Session->read('bookingMessage');?></div>
        </div>
      </div>
      <div class="col-sm-12 col-md-8">
        <form id="contactForm" action = "<?php echo SITE_PATH;?>Webs/booking" method="POST">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group">
              <input type="text" name="game" id="contactgame" value=""  class="form-control" placeholder="Game"/>
              <span class="small" id="contactgame-error" style="color:red;"></span>  
            </div>
          </div>
		    <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <input type="text" name="city" id="contactcity" value=""  class="form-control" placeholder="City"/>
              <span class="small" id="contactcity-error" style="color:red;"></span>  
            </div>
          </div>
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
      ...
      <div class="container">
        ...
        <div class="footer-icon-div">
          <ul class="list-inline list-unstyled footer-icon">
            ...
            <li><a href="javascript:void(0);"><img src="<?php echo SITE_PATH;?>/assets/images/google.png" width="28" height="28" alt=""/> Google +</a></li>
...
$("#contactSubmit").on('click', function(event) {
		...
		if ($( "#contactgame" ).val() === "") {
			formStatus = false;
			$( "#contactgame-error" ).text( "Please enter game" ).show().fadeOut( 7000 );
		}
		if ($( "#contactcity" ).val() === "") {
			formStatus = false;
			$( "#contactcity-error" ).text( "Please enter city" ).show().fadeOut( 7000 );
		}
